...
const TwoFactorAuth = () => {
  ...
  const handleVerifyCode = () => {
    if (code === otp) {
      ...
      console.log('OTP verification successful'); // Log success in terminal
      navigation.navigate('Homepage');  // Navigate to the homepage after successful OTP verification
    } else {
      Alert.alert('Error', 'Invalid OTP. Please try again.');
      console.log('Invalid OTP entered');  // Log invalid attempt in terminal
    }
  };
