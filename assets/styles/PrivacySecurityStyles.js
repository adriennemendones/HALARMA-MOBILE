...
const styles = StyleSheet.create({
  ...
  section: {
    marginBottom: 25,  // Increased spacing between sections for a more open feel
  },
  heading: {
  ...
  subheading: {
    ...
    marginBottom: 8,  // More space between subheading and text
  },
  paragraph: {
    ...
    marginBottom: 10,  // Consistent spacing between paragraphs
  },
});
